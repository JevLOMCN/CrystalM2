...
namespace Client.MirScenes
{
    ...
    public sealed class MapControl : MirControl
    {
        ...
        public const int OffSetX = Settings.ScreenWidth/2/CellWidth;
        public const int OffSetY = Settings.ScreenHeight/2/CellHeight - 2;

        public const int ViewRangeX = OffSetX + 4;
        public const int ViewRangeY = OffSetY + 4;
    ...
    public sealed class MainDialog : MirImageControl
    {
        ...
        public void Process()
        {
            ...
            ExperienceLabel.Location = new Point(390 - (ExperienceLabel.Size.Width/2), -10);
        ...
        public void ChangeSize()
        {
            ...
            switch (WindowSize)
            {
                case 0:
                    ...
                    Index = 2201;
                    CountBar.Index = 2012;
                    DownButton.Location = new Point(394, 39);
                    EndButton.Location = new Point(394, 45);
            ChatTextBox.Location = new Point(1, 54);
                ...
                case 1:
                    ...
                    Index = 2204;
                    CountBar.Index = 2013;
                    DownButton.Location = new Point(394, 39 + 48);
                    EndButton.Location = new Point(394, 45 + 48);
            ChatTextBox.Location = new Point(1, 54 + 48);
                ...
                case 2:
                    ...
                    Index = 2207;
                    CountBar.Index = 2014;
                    DownButton.Location = new Point(394, 39 + 96);
                    EndButton.Location = new Point(394, 45 + 96);
